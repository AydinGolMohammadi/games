...
import 'block_unit_manager.dart';
...
class _Game2048State extends State<Game2048> {
            ...
            Expanded(
              ...
              child: Container(
                  decoration: BoxDecoration(
                      color: const Color(0xffbaad9e),
                      borderRadius: BorderRadius.circular(8),
                      border:
                          Border.all(width: 6, color: const Color(0xffbaad9e))),
                  child: Column(
  ...
  List<Coordinate> getBlockEmptyList() {
    List<Coordinate> listBlockUnitEmpty = [];
    for (int row = 0; row < 4; row++) {
      for (int col = 0; col < 4; col++) {
        if (table[row][col].value == BLOCK_VALUE_NONE) {
